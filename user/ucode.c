...
int getline_file(char *s, int fd)
{
    int c;
    char *cp = s;
...
// appears to split by space delimeter
// so eatpath("this is a path", name);
// would have n = 4, name[0] = this, name[1] = is, name[2] = a, name[3] = path
